...
def main():
    # 配置参数
    TXT_DIRECTORY = r"C:\Users\25757\PycharmProjects\文献采集\DOI筛选_input_english"  # 包含文献txt的文件夹的位置目录
    OUTPUT_DIR = r"C:\Users\25757\PycharmProjects\文献采集\DOI筛选_output_english"  # 输出Excel文件夹的位置目录

    TOPIC = """Select Pt-based HER electrocatalyst articles.

    INCLUDE if abstract mentions "Pt" OR "platinum" AND mentions "HER" OR "hydrogen evolution".

    That's it. Just look for these keywords together.

    Output: {"result": "include"} or {"result": "exclude"}"""
